...
@endif
<form action="{{route('chambres.ajouter')}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="container col-md-6 border">
        <h4 class="text-center">
            {{$ok==='bon' ? "Modification des chambres pour le bien immobilier $bien->nom "   : "Ajout des chambres pour le bien immobilier $bien->nom "}}
        </h4><br>
        ...
        <div class="row ">
            ...
            <div class="d-flex justify-content-center align-items-center">
                ...
                <input type="submit" class="btn  btn-primary " style="width: 300px;" value="{{$ok==='bon' ? 'Modifier' : 'Ajouter'}}">
            </div>
        </div>
    </div>
</form>
