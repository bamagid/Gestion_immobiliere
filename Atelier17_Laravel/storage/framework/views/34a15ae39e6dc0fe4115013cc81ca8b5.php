    ...
    <aside
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <?php if(Auth::user()): ?>
                    <li class="nav-item">
                        <form method="POST" class="nav-link text-white " action="<?php echo e(route('logout')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              this.closest('form').submit();">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active bg-gradient-warning" href="<?php echo e(url('/newarticle')); ?>">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">assignment</i>
                        </div>
               ...
               <li class="nav-item">
                   <a class="nav-link text-white active bg-gradient-info" href="<?php echo e(url('/admin')); ?>">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">dashboard</i>
                    </div>
...
<?php /**PATH C:\Users\ladyr\Documents\SIMPLON\TAF\ATELIER\framework\atelier17_jym_immo\Gestion_immobiliere\Atelier17_Laravel\resources\views/layouts/template.blade.php ENDPATH**/ ?>